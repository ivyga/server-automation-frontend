...
export const About: React.FC = () => {
  return (
    <div>
      <h1>About</h1>
      <p>This site provides a quick start for UI development.</p>
      ...
      <p>Vite (pronounced "vit") was run with the "react-ts" option.  Out of the box, it laided out a basic project structure and gave us the ability to run/debug locally and build a "single page application" for produciton delploy.</p>
