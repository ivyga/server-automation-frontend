...
describe('About Component', () => {
    test('renders the About component with correct headings and content', () => {
        ...
        // Check for paragraph
        expect(screen.getByText(/this project uses the following technical stack:/i)).toBeInTheDocument();
        ...
        expect(screen.getByRole('heading', { level: 2, name: /vite build tool/i })).toBeInTheDocument();
        expect(
